---
name: comprehensive-codembly
description: Comprehensive skill combining all Codembly architecture skills: Agent Runtime, Tool Registry, Context Engine, AI Gateway, Architecture Planning, Monorepo Bootstrap, Performance/Startup, Browser/Scratchpad Runtime, Terminal Runtime, Wasm/LSP/Indexing, and Review/Audit.
---
