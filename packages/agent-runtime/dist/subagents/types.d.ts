 ...
 *
 * Core type system for the SubAgent architecture in Codembly.
 * SubAgents are specialized, focused agent units that execute specific
 * tasks delegated by the main Agent Orchestrator.
 */
export type PermissionLevel = "observe" | "suggest" | "edit" | "execute" | "autonomous";
export type RiskLevel = "low" | "medium" | "high";
export type SubAgentRole = "reader" | "searcher" | "writer" | "executor" | "reviewer" | "planner" | "context";
export type ToolName = "read_file" | "write_file" | "apply_patch" | "search_files" | "list_files" | "run_command" | "git_diff" | "run_tests" | "open_preview" | "reload_preview" | "collect_console_logs" | "collect_network_errors" | "capture_screenshot" | "scratchpad_execute" | "lsp_diagnostics" | "package_manager";
...
export type SubAgentResultStatus = "success" | "partial" | "failed" | "timeout" | "cancelled";
...
export interface Finding {
    category: "security" | "architecture" | "performance" | "quality" | "test-coverage";
    severity: RiskLevel;
    description: string;
    filePath?: string;
    line?: number;
...
export type SubAgentErrorCode = "TIMEOUT" | "TOOL_NOT_ALLOWED" | "PERMISSION_DENIED" | "CONTEXT_OVERFLOW" | "PROVIDER_ERROR" | "INTERNAL_ERROR" | "CANCELLED";
export type SubAgentEventType = "subagent:task:started" | "subagent:task:completed" | "subagent:task:failed" | "subagent:task:cancelled" | "subagent:tool:called" | "subagent:approval:required" | "subagent:progress:updated";
