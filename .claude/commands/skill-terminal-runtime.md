# Skill: Terminal Runtime

Use for Project Terminal Runtime design including PTY bridge, command policy, output parser, and agent-safe command execution.

Terminal Types: User Terminal, Agent Terminal, Task Terminal, Scratchpad Terminal.
